...
<?php $component->withAttributes([]); ?>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-xl-3 col-xxl-3 col-lg-3 col-md-3 col-sm-3 col-xs-2"> <!-- Column for the button -->
            <a href="<?php echo e(route('offices.create')); ?>" class="btn btn-primary">Létrehozás</a>
        </div>
    </div>
                                    ...
                                    <?php $__currentLoopData = \App\Models\Office::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center align-middle">
                                            ...
                                            <td id="smallTable"
                                                ...
                                                <?php echo e($office->office_name); ?></td>
                                            <td id="smallTable"
                                                class="bg-dark border-end border-secondary table-secondary text-secondary text-center">
                                                <?php echo e($office->office_manager); ?></td>
                                            <td id="smallTable"
                                                class="bg-dark border-end border-secondary table-secondary text-secondary text-center">
                                                <?php echo e($office->zip_code); ?> <?php echo e($office->city); ?>, <?php echo e($office->street); ?>

                                                <?php echo e($office->house_number); ?>.</td>
                                            <td id="smallTable"
                                                class="bg-dark border-end border-secondary table-secondary text-secondary text-center">
                                                <?php echo e($office->number_of_workers); ?></td>
                                            <td id="smallTable"
                                                class="bg-dark border-end border-secondary table-secondary  text-center">
                                                <form action="<?php echo e(route('offices.edit', $office)); ?>">
                                            ...
                                            <td id="smallTable" class="bg-dark  table-secondary text-center">
                                                <form method="POST" action="<?php echo e(route('offices.destroy', $office)); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\michnay.jozsef\HappyFuneralOfficeSupplies másolata\resources\views/offices/index.blade.php ENDPATH**/ ?>