...
<?php $component->withAttributes([]); ?>
    ...
    <div class="row mb-3">
        <div class="col-md-12 col-md-12 flex-container">
            ...
            <form class="text-center" id="orderdata_form" method="POST" action="<?php echo e(route('orderdata.store')); ?>">
                <?php echo csrf_field(); ?>
        ...
        <section class="row justify-center mt-1 p-5 pt-0 g-4">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div id='section1' class="card bg-dark text-white mb-4">
                    ...
                    <div class="card-body mt-2">
                        <form id="customer_form" action="<?php echo e(route('customer.store')); ?>" method="POST"
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div id='section2' class="card bg-dark text-white mb-4">
                    ...
                    <div class="card-body mt-2">
                        <form id="deceased_form" action="<?php echo e(route('deceaseds.store')); ?>" method="POST"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select class="form-select bg-secondary" name="hospital_code" required>
                                        ...
                                        <?php $__currentLoopData = \App\Models\HutosIdo::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hutosido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($hutosido->id); ?>"><?php echo e($hutosido->kh_name); ?>
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div id='section3' class="card bg-dark text-white mb-4">
                    ...
                    <div class="card-body mt-2">
                        <form id="birthcert_form" action="<?php echo e(route('birth_certificate.store')); ?>" method="POST"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                <div class="col-md-6">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div id='section4' class="card bg-dark text-white mb-4">
                    ...
                    <div class="card-body mt-2">
                        <form id="urnkia_form" action="<?php echo e(route('urn_k_i_a_data.store')); ?>" method="POST"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row text-center g-3">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <select class="form-select bg-secondary" id="" name=""
                                            ...
                                            <?php $__currentLoopData = \App\Models\KremaList::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $krema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($krema->id); ?>"><?php echo e($krema->name); ?>
                                ...
                                <div class="col-md-12">
                                    <select name="urn_inside_form" class="form-select form-text bg-secondary"
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $urns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $urn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($urn->name); ?>"><?php echo e($urn->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-12">
...
<?php endif; ?>
<?php /**PATH C:\Users\michnay.jozsef\HappyFuneralOfficeSupplies másolata\resources\views/deceaseds/create.blade.php ENDPATH**/ ?>