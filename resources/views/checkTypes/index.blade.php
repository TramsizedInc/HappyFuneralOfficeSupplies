                ...
                <div class="bg-white border rounded-sm divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                    ...
                    <div class="overflow-hidden">
                        <table class="table-auto min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Csekk típus</th>
                            ...
                            @foreach(\App\Models\CheckType::all() as $checkType)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{$checkType->name}}</td>

                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        <form action="{{route('checkTypes.edit',$checkType)}}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        <form method="POST" action="{{route('checkTypes.destroy',$checkType)}}">
                                            @csrf
                                            @method('DELETE')
