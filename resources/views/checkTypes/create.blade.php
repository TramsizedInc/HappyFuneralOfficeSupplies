...
@section('content')
    ...
    <div class="min-h-screen p-6 flex items-center justify-center">
        <form action="{{ route('checkTypes.store') }}" method="POST" enctype="multipart/form-data" class="container max-w-screen-lg mx-auto">
            @csrf
            @method('POST')
            <div>
                <h2 class="font-semibold text-xl text-gray-600">Csekk típus létrehozás</h2>
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-2 mb-3">
                            ...
                            <div class="md:col-span-5">
                                ...
                                <input type="text" name="name" id="docs" class="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Csekk típus">
                            </div>
