...
<div class="min-h-screen p-6 flex items-center justify-center">
    <form action="{{ route('brands.update',$brand) }}" method="POST" enctype="multipart/form-data" class="container max-w-screen-lg mx-auto">
        ...
        @method('PUT')
        <div>
            <h2 class="font-semibold text-xl text-gray-600">Brand modosítása</h2>
                    ...
                    <div class="lg:col-span-2 mb-3">
                        ...
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-5">
                                ...
                                <input type="text" name="name" id="docs" value="{{$brand->name}}" class="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Brand">
                            </div>
