            ...
            <aside class="col-auto px-0">
                <div class="row flex-nowrap">
                    <div class="col-auto px-0">
                        <div id="sidebar" class="collapse-horizontal border-end">
                            <div id="sidebar-nav"
                                class="list-group border-0 bg-dark text-white rounded-0 text-sm-start min-vh-100">
                                <ul class="nav flex-column sidebar-nav">
                                    <div class="sidebar-header">
                                        <img src="{{ asset('storage/logo.png') }}" id="logo" class="img-fluid"
                                            alt="logo">
                                    ...
                                    <div class="mt-3 text-start">
                                        <li class="nav-item dropdown mt-3">
                                            <a data-bs-parent="#sidebar" class="nav-link text-light dropdown-toggle"
                                                href="#" id="dropdownMenuLink1" role="button"
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                <li>
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('deceaseds.create') }}"><i
                                                            class="fas fa-plus p-2"></i> Új ügy
                                                        felvétele</a>
                                                </li>
                                                <li class="border-top border-secondary">
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('orderdata.index') }}"><i
                                                            class="fas fa-table p-2"></i>Tárolt ügyek</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="nav-item dropdown mt-3">
                                            <a data-bs-parent="#sidebar" class="nav-link text-light dropdown-toggle"
                                                href="#" id="dropdownMenuLink2" role="button"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                Nyomtatók
                                            </a>
                                                ...
                                                <li>
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('printers.index') }}"><i
                                                            class="fas fa-wrench p-2"></i>Nyomtatók
                                                        kezelése</a>
                                                </li>
                                                <li>
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('getPrinterData') }}"><i
                                                            class="fas fa-chart-line"></i> Nyomtató
                                                        statisztikái</a>
                                                </li>
                                                <li>
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('printerTypes.index') }}"><i
                                                            class="fas fa-cog p-2"></i>Nyomtató fajták
                                                        kezelése</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="nav-item dropdown mt-3">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                <li>
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('cars.create') }}"><i
                                                            class="fas fa-plus p-2"></i> Új autó
                                                        hozzáadás</a>
                                                </li>
                                                <li class="border-top border-secondary">
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('cars.index') }}"><i
                                                            class="fas fa-table p-2"></i>Tárolt autók</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="nav-item dropdown mt-3">
                                                ...
                                                <li>
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('checkModels.index') }}"><i
                                                            class="fas fa-table p-2"></i>Összes számla</a>
                                                </li>
                                                <li>
                                                    <a data-bs-parent="#sidebar" class="dropdown-item"
                                                        href="{{ route('checkTypes.index') }}"><i
                                                            class="fas fa-wrench p-2"></i>Csekkek
                                                        kezelése</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="nav-item dropdown mt-3">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink5">
                                                <li>
                                                    <a data-bs-parent="#sidebar"
                                                        class="dropdown-item disabled text-dark" href="#"><i
            ...
            <main class="col py-3">
                ...
                <div class="container mt-5">
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-sm-12 me-5">
                            <div class="card bg-dark text-light mb-4">
                                <div class="card-header">
                                    <h1 class="ps-5 mb-3">Céges infók:</h1>
                                </div>
                                <div class="card-body d-flex overflow-hidden flex-wrap ">
                                    <div class="row g-2">
                                            ...
                                            <div class="col-4">
                                                <div class="card  m-2 bg-secondary text-light">
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item ">Adószám:
                                                            {{ $company['tax_number'] }}</li>
                                                        <li class="list-group-item fw-bold">Cím:
                                                            {{ $company['address'] }}
                                                        </li>
                                                        ...
                                                        <li class="list-group-item fw-bold">Voip:
                                                            {{ $company['phone'] }}</li>
                                                    </ul>
                                                    <div class="card-footer ">
                                                       <a href=" " class="fw-bold text-dark"> Mobilszám: {{ $company['mobile'] }} </a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
