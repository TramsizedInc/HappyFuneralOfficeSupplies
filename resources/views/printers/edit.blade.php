                            ...
                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                <div class="md:col-span-5 mb-3">
                                    <select name="office_id" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" data-te-select-init>
                                        @foreach(\App\Models\Office::all() as $office)
                                            @if($printer->office_id === $office->id)
                                ...
                                <div class="md:col-span-5 mb-3">
                                    ...
                                    <select name="type" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" data-te-select-init>
                                        @foreach(\App\Models\PrinterType::all() as $printer1)
                                            @if($printer1->name === $printer->type)
                                                <option selected value="{{$printer1->name}}">{{$printer1->name}}</option>
                                            @else
                                                <option value="{{$printer1->name}}">{{$printer1->name}}</option>
                                            @endif
