<x-app-layout>
    ...
    <div class="row mb-3">
        ...
        <section class="row align-center mt-1 p-5 pt-0 g-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="phone-input"
                                        ...
                                        pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" placeholder="+36 00-000-0000" required />
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="card-body mt-2">
                        <form id="deceased_form" action="{{ route('deceaseds.store') }}" method="POST"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control bg-secondary text-white" type="text"
                                        name="hospital_code" id="hospital_code"
                                ...
                                <div class="col-md-6">
                                    <input datetimepicker class="form-control bg-secondary text-white"
                                        name="birth_day" id="birth_day" type="text"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input  ps-1" type="radio" name="divorced_or_not" id="maritalStatus1" value="Igen">
                                        <label class="form-check-label" for="maritalStatus1">
                                            Igen
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="divorced_or_not" id="maritalStatus2" value="Nem">
                ...
                <div id='section4' class="card bg-dark text-white mb-4">
                    ...
                    <div class="card-body mt-2">
                        <form id="urnkia_form" action="{{ route('urn_k_i_a_data.store') }}" method="POST"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <input class="form-control bg-secondary text-white" id="hv_is_done"
                                        name="hv_is_done" type="text" placeholder="Boncolás történt-e" required>
                                </div>
                                <div class="col-md-6">
