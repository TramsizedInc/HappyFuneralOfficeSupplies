<x-app-layout>
    ...
    <div class=" mt-4">
        ...
        <section class="row align-center p-5 g-4">
                    ...
                    <div class="card-body mt-2">
                        <form id="customer_form" action="{{ route('customer.store') }}" method="POST"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="phone-input" class="form-control bg-secondary text-white"
                                ...
                                <div class="col-md-6">
                                    <input class="form-control bg-secondary text-white" id="zip_code" name="zip_code"
                                        type="text" placeholder="Irányítószám" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control bg-secondary text-white" id="death_place"
                                        name="death_place" type="text" placeholder="Elhalálozás helysége"
                                        required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control bg-secondary text-white" id="ash_storage_place"
                                        name="ash_storage_place" type="text"
                                ...
                                <div class="col-md-6">
                                    <input class="form-control bg-secondary text-white" id="dead_husbands_count"
                                        name="dead_husbands_count" type="number"
                    ...
                    <div class="card-body mt-2">
                        <form id="urnkia_form" action="{{ route('urn_k_i_a_data.store') }}" method="POST"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <select name="urn_inside_form" class="form-control form-select bg-secondary "
                                        id="urn_inside_form">
